...
\begin{figure}
	\centering
	\includegraphics[scale=1]{cav_ring2a.pdf}
...
p &= 0 && \text{on } \Gamma_0\\
p &= \pcc && \text{on } \Gamma_+\\
\theta &= \theta_{\textnormal{in}} && \text{on } \partial\Omega_\textnormal{in}
\end{align*} 
\end{minipage}%
\hspace*{0.3cm}
\begin{minipage}{0.5\linewidth}
...
\end{cases},
\end{equation*}
This corresponds to the classical Elrod-Adams model for $\pcc=0$.\\
...
\begin{table}\centering {\small
		\begin{tabular}{ccccccccc}
			...
			\multicolumn{6}{c}{$\Delta h$ (microns)} \\
			& 0.5 & 1.0& 1.5& 2.0 & 2.5& 3.0 & 3.5 & 4.0-8.0\\
			\midrule
			$\delta^\tm{max}$ (microns) & 0.020 &0.030 & 0.035 & 0.040 & 0.045 & 0.050 & 0.020& 0\\
			\bottomrule
	\end{tabular}}
...
\end{itemize}
	\begin{figure}
	\includegraphics[scale=0.6]{peq_req2}
\end{figure}
\end{frame} 
...
\begin{figure}[h]
	\includegraphics[scale=1]{drawing_h_f1.pdf}
\end{figure}
\end{frame} 
...
\begin{figure}
	\centering 
	\def\svgwidth{\textwidth}	
	\includegraphics[scale=0.4]{grupo_san_carlos.png}
\end{figure}
\end{frame}
%==============================================================
